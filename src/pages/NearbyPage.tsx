  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0a]">
      <div className="px-6 pt-16 pb-6">
        ...
        <h1 className="text-[34px] font-medium text-gold-gradient tracking-[0.15em]">附 近 能 吃 到</h1>
        <p className="text-[13px] text-[#777] tracking-wider mt-3">想吃的食物，現在哪些在附近</p>
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-28">
        {!location ? (
          ...
          <div className="flex flex-col gap-3">
            <p className="text-[13px] tracking-[0.3em] text-[#8a8478] pb-2">
              {nearby.length} 道食物現在吃得到
            </p>
            {nearby.map(({ item, dist }) => (
              <div key={item.id}>
                <div className="flex items-center gap-1.5 mb-2 text-[#c9a961]/80">
                  <MapPin size={12} />
