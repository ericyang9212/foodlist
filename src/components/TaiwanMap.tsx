...
// 去過的縣市走松綠色階（淺 → 深），沒去過的維持淺灰；顏色深淺＝足跡多寡
const NOT_VISITED_COLOR = '#e4e4ea';
const LOW_RGB: [number, number, number] = [0xa8, 0xdd, 0xd4];
const HIGH_RGB: [number, number, number] = [0x00, 0x60, 0x54];
        ...
        return (
          <path
            ...
            style={{
              ...
              filter: isTop ? 'drop-shadow(0 2px 6px rgba(0, 96, 84, 0.45))' : undefined,
            }}
